...
example: octokit.apps.listMarketplacePurchasesForAuthenticatedUser()
...
See also: [GitHub Developer Guide documentation](https://developer.github.com/v3/apps/marketplace/#list-subscriptions-for-the-authenticated-user).
