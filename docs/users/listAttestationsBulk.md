...
```js
octokit.rest.users.listAttestationsBulk({
  username,
  subject_digests,
});
```
...
See also: [GitHub Developer Guide documentation](https://docs.github.com/rest/users/attestations#list-attestations-by-bulk-subject-digests).
