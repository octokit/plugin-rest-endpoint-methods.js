...
name: List repository custom patterns
example: octokit.rest.secretScanning.listRepoCustomPatterns({ owner, repo })
...
```js
octokit.rest.secretScanning.listRepoCustomPatterns({
  owner,
  repo,
});
```
...
See also: [GitHub Developer Guide documentation](https://docs.github.com/rest/secret-scanning/custom-patterns#list-repository-custom-patterns).
