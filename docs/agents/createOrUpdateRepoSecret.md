...
example: octokit.rest.agents.createOrUpdateRepoSecret({ owner, repo, secret_name, encrypted_value, key_id })
...
```js
octokit.rest.agents.createOrUpdateRepoSecret({
  owner,
  repo,
  secret_name,
  encrypted_value,
...
See also: [GitHub Developer Guide documentation](https://docs.github.com/rest/agents/secrets#create-or-update-a-repository-secret).
