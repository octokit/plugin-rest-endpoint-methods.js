...
example: octokit.rest.agents.setSelectedReposForOrgSecret({ org, secret_name, selected_repository_ids })
...
```js
octokit.rest.agents.setSelectedReposForOrgSecret({
  org,
  secret_name,
...
See also: [GitHub Developer Guide documentation](https://docs.github.com/rest/agents/secrets#set-selected-repositories-for-an-organization-secret).
