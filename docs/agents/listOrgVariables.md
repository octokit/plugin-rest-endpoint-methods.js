...
example: octokit.rest.agents.listOrgVariables({ org })
...
```js
octokit.rest.agents.listOrgVariables({
  org,
});
```
...
See also: [GitHub Developer Guide documentation](https://docs.github.com/rest/agents/variables#list-organization-variables).
