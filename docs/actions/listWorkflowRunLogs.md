---
name: List workflow run logs
example: octokit.actions.listWorkflowRunLogs({ owner, repo, run_id })
...
See also: [GitHub Developer Guide documentation](https://developer.github.com/v3/actions/workflow-runs/#list-workflow-run-logs).
