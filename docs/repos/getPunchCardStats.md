...
See also: [GitHub Developer Guide documentation](https://docs.github.com/enterprise-cloud@latest//rest/statistics/repos#get-the-hourly-commit-count-for-each-day).
