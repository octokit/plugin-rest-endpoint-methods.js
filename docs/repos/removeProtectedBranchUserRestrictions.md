...
**Deprecated:** This method has been renamed to repos.removeUserAccessRestrictions
...
See also: [GitHub Developer Guide documentation](https://developer.github.com/v3/repos/branches/#remove-user-access-restrictions).
