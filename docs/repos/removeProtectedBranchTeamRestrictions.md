...
example: octokit.repos.removeProtectedBranchTeamRestrictions({ owner, repo, branch, teams })
...
See also: [GitHub Developer Guide documentation](https://developer.github.com/v3/repos/branches/#remove-team-restrictions-of-protected-branch).
