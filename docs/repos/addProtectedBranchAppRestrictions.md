...
example: octokit.repos.addProtectedBranchAppRestrictions({ owner, repo, branch, apps })
...
See also: [GitHub Developer Guide documentation](https://developer.github.com/v3/repos/branches/#add-app-restrictions-of-protected-branch).
