...
name: Get billing AI credit usage report for an organization
example: octokit.rest.billing.getGithubBillingAiCreditUsageReportOrg({ org })
...
```js
octokit.rest.billing.getGithubBillingAiCreditUsageReportOrg({
  org,
});
```
...
See also: [GitHub Developer Guide documentation](https://docs.github.com/rest/billing/usage#get-billing-ai-credit-usage-report-for-an-organization).
