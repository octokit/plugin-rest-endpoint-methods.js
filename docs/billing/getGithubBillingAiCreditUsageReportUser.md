...
name: Get billing AI credit usage report for a user
example: octokit.rest.billing.getGithubBillingAiCreditUsageReportUser({ username })
...
```js
octokit.rest.billing.getGithubBillingAiCreditUsageReportUser({
  username,
});
```
...
See also: [GitHub Developer Guide documentation](https://docs.github.com/rest/billing/usage#get-billing-ai-credit-usage-report-for-a-user).
