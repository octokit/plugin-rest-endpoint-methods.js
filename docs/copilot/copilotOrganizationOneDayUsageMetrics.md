...
name: Get Copilot organization usage metrics for a specific day
example: octokit.rest.copilot.copilotOrganizationOneDayUsageMetrics({ org, day })
...
```js
octokit.rest.copilot.copilotOrganizationOneDayUsageMetrics({
  org,
  day,
});
```
...
See also: [GitHub Developer Guide documentation](https://docs.github.com/rest/copilot/copilot-usage-metrics#get-copilot-organization-usage-metrics-for-a-specific-day).
