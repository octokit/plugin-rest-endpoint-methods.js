...
name: Disable a repository for Copilot cloud agent in an organization
example: octokit.rest.copilot.disableCopilotCodingAgentForRepositoryInOrganization({ org, repository_id })
...
```js
octokit.rest.copilot.disableCopilotCodingAgentForRepositoryInOrganization({
  org,
  repository_id,
});
```
...
See also: [GitHub Developer Guide documentation](https://docs.github.com/rest/copilot/copilot-coding-agent-management#disable-a-repository-for-copilot-cloud-agent-in-an-organization).
