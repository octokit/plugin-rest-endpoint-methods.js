...
name: Get Copilot enterprise usage metrics
example: octokit.rest.copilot.copilotEnterpriseUsageMetrics({ enterprise })
...
```js
octokit.rest.copilot.copilotEnterpriseUsageMetrics({
  enterprise,
});
```
...
See also: [GitHub Developer Guide documentation](https://docs.github.com/rest/copilot/copilot-usage-metrics#get-copilot-enterprise-usage-metrics).
